...
namespace SimpleDartsChallenge
{
    public class Game
    {
        ...
        public Game(string player1Name, string player2Name) //Initialize players and define names
        {
            _player1 = new Player();
        ...
        public string Play() // Lets game continue w/score <300
        {
        ...
        {
            for (int i = 0; i < 3; i++)//3 darts thrown by player
            {
